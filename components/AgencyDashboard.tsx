            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1">
                  ${trip.documents.slice(0, 3).map(doc => html`
              ...
              <div className="pt-2 border-t border-slate-50">
                 ...
                 <div className="flex flex-wrap gap-1.5">
                    ${trip.recommendations?.map((rec, i) => html`
                      <div key=${i} className="bg-[#EE8F66]/5 px-2.5 py-1 rounded-lg text-[10px] font-bold text-[#EE8F66] border border-[#EE8F66]/10 flex items-center gap-1.5 group/rec transition-all hover:bg-[#EE8F66]/10">
                        ${rec.title} ${rec.source === 'agency' && html`<button onClick=${() => openEditRecommendation(trip.id, rec)} className="p-0.5 hover:text-[#3D3D3D] transition-colors"><${Pencil} size=${10} /></button>`}
                      </div>
                    `)}
                 </div>
              </div>
